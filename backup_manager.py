...
return os.path.join(self.__backup_dir,self.__all_backups[backup_id], self.backups_files[backup_id][file_id][0][:2], self.backups_files[backup_id][file_id][0])


test = BackupManager('C:\\Users\\MSI\\Downloads\\backup samples')
test.search_backups()
